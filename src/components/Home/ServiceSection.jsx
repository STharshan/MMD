...
const services = [
  {
    title: "Diagnostics",
    desc: `Uses advanced tools to identify and troubleshoot vehicle issues, ensuring accurate repairs`,
    image: "/carpaint.avif",
    path: "/services/mechanical",
  },
  {
    title: "Remapping",
    desc: `Enhances vehicle performance by adjusting the engine's software, offering more power, better fuel efficiency
​`,
    image: "/gray.avif",
              ...
              >
                ...
                <div className="max-w-sm mx-auto">
                  <img
                    src={service.image}
                    alt={service.title}
                    className="absolute inset-0 rounded-2xl w-[75%] mt-15 mx-auto h-45 object-cover"
                    onError={(e) => {
